                    ...
                    <div className='stakebody__box'>
                        {nft.tokenAddress === "0x51112Bf32B9a1C64716DF2e6b82e63a04Bd384Fd" &&
                            <img className="stakebody__boxImg"
                                   src={`https://ik-proxy.b-cdn.net/proxy/https://metadata.trooprz.army/series-2/${nft.tokenId}.png`}
                                   alt=""></img>
                        }
                        {nft.tokenAddress !== "0x51112Bf32B9a1C64716DF2e6b82e63a04Bd384Fd" &&
                        <img className="stakebody__boxImg" src={`${nft.tokenImage}`} alt=""></img>
                        }
                        <div className='stakebody__boxText'>
                            <p className='stakebody__boxRank'>{nft.name}</p>
                            <p className='stakebody__boxTitle'>ID: {nft.tokenId}</p>
                            <p className='stakebody__boxReward'>Daily Yield: {nft.dailyReward} TRPZ</p>
                ...
                {filter !== "Staked" && params.NFTObjects.map((heldNFT, index) => {
                    ...
                    <div className='stakebody__box'>
                        {heldNFT.tokenAddress === "0x51112Bf32B9a1C64716DF2e6b82e63a04Bd384Fd" &&
                            <img className="stakebody__boxImg"
                                 src={`https://ik-proxy.b-cdn.net/proxy/https://metadata.trooprz.army/series-2/${heldNFT.tokenId}.png`}
                                 alt=""></img>
                        }
                        {heldNFT.tokenAddress !== "0x51112Bf32B9a1C64716DF2e6b82e63a04Bd384Fd" &&
                            <img className="stakebody__boxImg" src={`${heldNFT.tokenImage}`} alt=""></img>
                        }
                        <div className='stakebody__boxText'>
                            <p className='stakebody__boxRank'>{heldNFT.name}</p>
                            <p className='stakebody__boxTitle'>ID: {heldNFT.tokenId}</p>
                            <p className='stakebody__boxReward'>Daily Yield: {heldNFT.dailyReward} TRPZ</p>
                            <div className='stakebody__boxButtons'>
